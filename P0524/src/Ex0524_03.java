...
public class Ex0524_03 {
	...
	System.out.println("t1의 첫 번째 좌표 :"+t1.p[0].x+t1.p[0].y);
	System.out.println("t1의 두 번째 좌표 :"+t1.p[1].x+t1.p[1].y);
	System.out.println("t1의 세 번째 좌표 :"+t1.p[2].x+t1.p[2].y);
